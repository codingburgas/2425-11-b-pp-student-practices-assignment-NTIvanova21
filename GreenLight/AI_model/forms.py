...
class LoanForm(FlaskForm):
    ...
    education = RadioField('Education Degree',choices=[('high_school', 'High School Diploma'),('bachelor', 'Bachelor Degree'),('masters', 'Masters Degree'),('phd', 'PhD')],validators=[InputRequired()],coerce=str)
